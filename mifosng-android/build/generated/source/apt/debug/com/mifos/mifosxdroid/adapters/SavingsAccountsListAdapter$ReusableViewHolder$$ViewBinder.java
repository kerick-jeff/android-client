...
public class SavingsAccountsListAdapter$ReusableViewHolder$$ViewBinder<T extends SavingsAccountsListAdapter.ReusableViewHolder> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends SavingsAccountsListAdapter.ReusableViewHolder> implements Unbinder {
    private T target;
