...
public final class Currency_Adapter extends ModelAdapter<Currency> {
  ...
  public final String getInsertStatementQuery() {
    return "INSERT INTO `SavingAccountCurrency`(`code`,`name`,`decimalPlaces`,`inMultiplesOf`,`displaySymbol`,`nameCode`,`displayLabel`) VALUES (?,?,?,?,?,?,?)";
  }
  ...
  public final String getCreationQuery() {
    return "CREATE TABLE IF NOT EXISTS `SavingAccountCurrency`(`code` TEXT,`name` TEXT,`decimalPlaces` INTEGER,`inMultiplesOf` INTEGER,`displaySymbol` TEXT,`nameCode` TEXT,`displayLabel` TEXT, PRIMARY KEY(`code`)" + ");";
  }
