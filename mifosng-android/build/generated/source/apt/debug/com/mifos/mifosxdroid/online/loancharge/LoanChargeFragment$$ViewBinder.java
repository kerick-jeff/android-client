...
public class LoanChargeFragment$$ViewBinder<T extends LoanChargeFragment> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558685, "field 'mNoChargesIcon' and method 'reloadOnError'");
    target.mNoChargesIcon = finder.castView(view, 2131558685, "field 'mNoChargesIcon'");
  ...
  protected static class InnerUnbinder<T extends LoanChargeFragment> implements Unbinder {
    private T target;
