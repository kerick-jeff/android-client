...
public class SyncLoanRepaymentTransactionFragment$$ViewBinder<T extends SyncLoanRepaymentTransactionFragment> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends SyncLoanRepaymentTransactionFragment> implements Unbinder {
    private T target;
