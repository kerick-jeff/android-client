...
public class SyncClientPayloadsFragment$$ViewBinder<T extends SyncClientPayloadsFragment> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    InnerUnbinder unbinder = createUnbinder(target);
    View view;
    view = finder.findRequiredView(source, 2131558881, "field 'rv_payload_clients'");
    target.rv_payload_clients = finder.castView(view, 2131558881, "field 'rv_payload_clients'");
  ...
  protected static class InnerUnbinder<T extends SyncClientPayloadsFragment> implements Unbinder {
    private T target;
    ...
    protected void unbind(T target) {
      target.rv_payload_clients = null;
