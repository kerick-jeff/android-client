...
public class SyncGroupPayloadsFragment$$ViewBinder<T extends SyncGroupPayloadsFragment> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    InnerUnbinder unbinder = createUnbinder(target);
    View view;
    view = finder.findRequiredView(source, 2131558881, "field 'rv_payload_group'");
    target.rv_payload_group = finder.castView(view, 2131558881, "field 'rv_payload_group'");
  ...
  protected static class InnerUnbinder<T extends SyncGroupPayloadsFragment> implements Unbinder {
    private T target;
