...
public class LoanChargeDialogFragment$$ViewBinder<T extends LoanChargeDialogFragment> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends LoanChargeDialogFragment> implements Unbinder {
    private T target;
